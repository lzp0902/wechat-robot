...
public class WechatMeta {
	...
	public String toString() {
		return "WechatMeta [base_uri=" + base_uri + ", redirect_uri="
				+ redirect_uri + ", webpush_url=" + webpush_url + ", uuid="
				+ uuid + ", skey=" + skey + ", synckey=" + synckey + ", wxsid="
				+ wxsid + ", wxuin=" + wxuin + ", pass_ticket=" + pass_ticket
				+ ", deviceId=" + deviceId + ", cookie=" + cookie
				+ ", baseRequest=" + baseRequest + ", SyncKey=" + SyncKey
				+ ", User=" + User + "]";
	}
